...
latex_documents = [
    (master_doc, 'dynalist.tex', 'dynalist Documentation',
     'feng', 'manual'),
]
...
man_pages = [
    (master_doc, 'dynalist', 'dynalist Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dynalist', 'dynalist Documentation',
     author, 'dynalist', 'One line description of project.',
     'Miscellaneous'),
]
